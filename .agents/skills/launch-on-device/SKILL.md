...
adb shell am start -n com.github.zly2006.zhihu.lite/com.github.zly2006.zhihu.MainActivity
```
...
Expected output: `Starting: Intent { cmp=com.github.zly2006.zhihu.lite/com.github.zly2006.zhihu.MainActivity }`
...
adb exec-out run-as com.github.zly2006.zhihu.lite cat files/account.json \
...
adb shell run-as com.github.zly2006.zhihu.lite sh -c 'cp /data/local/tmp/zhihu-account.json files/account.json && chmod 600 files/account.json'
adb shell am force-stop com.github.zly2006.zhihu.lite
adb shell monkey -p com.github.zly2006.zhihu.lite -c android.intent.category.LAUNCHER 1
```
...
adb shell am instrument -w \
  ...
  com.github.zly2006.zhihu.lite.test/com.github.zly2006.zhihu.ZhihuInstrumentedTestRunner
```
...
1. **Lite Version** (recommended for development)
   - Package: `com.github.zly2006.zhihu.lite`
...
**Symptom:**
```
Failure [INSTALL_FAILED_UPDATE_INCOMPATIBLE: Existing package com.github.zly2006.zhihu.lite signatures do not match newer version]
```

**Solution:**
```bash
# Uninstall existing app first
adb uninstall com.github.zly2006.zhihu.lite
...
adb -s <device-id> shell am start -n com.github.zly2006.zhihu.lite/com.github.zly2006.zhihu.MainActivity
```
...
adb logcat | grep -i "AndroidRuntime\|FATAL\|zly2006.zhihu"

# Or filter by app package
adb logcat --pid=$(adb shell pidof -s com.github.zly2006.zhihu.lite)

# Clear app data and try again
adb shell pm clear com.github.zly2006.zhihu.lite
adb shell am start -n com.github.zly2006.zhihu.lite/com.github.zly2006.zhihu.MainActivity
```
...
adb shell pm list packages | grep zly2006

# Check main activity from manifest
adb shell dumpsys package com.github.zly2006.zhihu.lite | grep -A 1 "android.intent.action.MAIN:"
...
adb shell pm path com.github.zly2006.zhihu.lite
...
# Get app info
adb shell dumpsys package com.github.zly2006.zhihu.lite
```
...
```bash
./gradlew assembleLiteDebug && adb install -r ./app/build/outputs/apk/lite/debug/app-lite-debug.apk && adb shell am start -n com.github.zly2006.zhihu.lite/com.github.zly2006.zhihu.MainActivity
```
...
PACKAGE_NAME="com.github.zly2006.zhihu.lite"
...
7. ✅ Is package name correct? → `com.github.zly2006.zhihu.lite`
