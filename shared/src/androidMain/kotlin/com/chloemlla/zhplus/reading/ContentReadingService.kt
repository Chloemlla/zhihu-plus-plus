...
package com.chloemlla.zhplus.reading
...
import com.chloemlla.zhplus.data.decodeZhihuCommentData
...
class ContentReadingService : Service() {
    ...
    companion object {
        const val ACTION_START = "com.chloemlla.zhplus.reading.START"
        const val ACTION_TOGGLE = "com.chloemlla.zhplus.reading.TOGGLE"
        const val ACTION_PLAY = "com.chloemlla.zhplus.reading.PLAY"
        const val ACTION_PAUSE = "com.chloemlla.zhplus.reading.PAUSE"
        const val ACTION_PREVIOUS = "com.chloemlla.zhplus.reading.PREVIOUS"
        const val ACTION_NEXT = "com.chloemlla.zhplus.reading.NEXT"
        const val ACTION_PLAY_AT = "com.chloemlla.zhplus.reading.PLAY_AT"
        const val ACTION_SET_PLAYBACK_SPEED = "com.chloemlla.zhplus.reading.SET_PLAYBACK_SPEED"
        const val ACTION_STOP = "com.chloemlla.zhplus.reading.STOP"
        const val EXTRA_INDEX = "index"
        const val EXTRA_PLAYBACK_SPEED = "playback_speed"

        private const val TAG = "ContentReadingService"
        private const val MAIN_ACTIVITY_CLASS_NAME = "com.chloemlla.zhplus.MainActivity"
        const val READING_NOTIFICATION_INTENT_EXTRA = "com.chloemlla.zhplus.reading.NOTIFICATION_CONTENT"
